function [ c_struct, slices_p, image_height_p, image_width_p, coeff_vars] = VoxelStatsGLM( imageType, stringModel, distribution, data_file, mask_file, multivalueVariables, categoricalVars, includeString, multiVarOperationMap )
    functionTimer = tic;
