function VoxelStats()
    ...
    tab6 = uitab('Parent', tgroup, 'Title', 'Proportions Test');
    ...
    %UI controls in Tab6 = PropTest
    lblDataCol_propt = uicontrol('Tag', 'lblDataCol_propt','Parent', tab6, 'Style', 'text', 'String', ...
    'Image Column:', 'HorizontalAlignment', 'left', 'units', 'normalized', 'Position', [0.05 0.85 0.3 0.09]) ;
    txtDataCol_propt = uicontrol('Tag', 'txtDataCol_propt','Parent', tab6, 'Style', 'edit', ...
    'units', 'normalized', 'Position', [0.25 0.85 0.7 0.09], 'HorizontalAlignment', 'left') ;

    lblGroupCol_propt = uicontrol('Tag', 'lblGroupCol_propt','Parent', tab6, 'Style', 'text', 'String', ...
    'Grouping Column:', 'HorizontalAlignment', 'left', 'units', 'normalized', 'Position', [0.05 0.75 0.3 0.09]) ;
    txtGroupCol_propt = uicontrol('Tag', 'txtGroupCol_propt','Parent', tab6, 'Style', 'edit', ...
    'units', 'normalized', 'Position', [0.25 0.75 0.7 0.09], 'HorizontalAlignment', 'left') ;

    runVS_propt = uicontrol('Tag', 'runVS_propt','Parent', tab6, 'Style', 'pushbutton', ...
    'String', 'Run','units', 'normalized', 'Position', [0.75 0.45 0.2 0.1], 'CallBack', {@runVS, 'propt'}) ;

    writePanel_propt = uipanel('Tag', 'writePanel_propt','Parent', tab6, 'units', 'normalized', ...
    'Position', [0.45 0 0.54 0.45], 'Title', 'Write Results', ...
    'FontSize',14, 'FontName', 'Avenir');
    
    lblEst_propt = uicontrol('Tag', 'lblEst_propt','Parent', writePanel_propt, 'Style', 'text', 'String', ...
    'Estimate:', 'HorizontalAlignment', 'left', 'units', 'normalized', 'Position', [0.01 0.75 0.3 0.25]) ;
    chooseEst_propt = uicontrol('Tag', 'chooseEst_propt', 'Parent', writePanel_propt, 'Style', 'popupmenu', ...
     'String', {''}, 'units', 'normalized', 'Position', [0.2 0.75 0.75 0.25], ...
    'CallBack', {@chooseVariable, 'propt'}) ;

    lblTemplate_propt = uicontrol('Tag', 'lblTemplate_propt','Parent', writePanel_propt, 'Style', 'text', 'String', ...
    'Template:', 'HorizontalAlignment', 'left', 'units', 'normalized', 'Position', [0.01 0.25 0.3 0.25]) ;
    txtTemplate_propt = uicontrol('Tag', 'txtTemplate_propt','Parent', writePanel_propt, 'Style', 'edit', ...
    'units', 'normalized', 'Position', [0.21 0.31 0.72 0.2], 'HorizontalAlignment', 'left') ;
    
    chooseTemplate_propt = uicontrol('Tag', 'chooseTemplate_propt', 'Parent', writePanel_propt, 'Style', 'pushbutton', ...
    'String', 'Browse','units', 'normalized', 'Position', [0.32 0.05 0.19 0.24], 'CallBack', {@chooseFile, txtTemplate_propt}) ;
 
    writeResult_propt = uicontrol('Tag', 'writeResult_propt', 'Parent', writePanel_propt, 'Style', 'pushbutton', ...
    'String', 'Save','units', 'normalized', 'Position', [0.75 0.05 0.19 0.24], 'CallBack', {@saveRes, 'propt'}) ;

    viewResult_propt = uicontrol('Tag', 'viewResult_propt', 'Parent', writePanel_propt, 'Style', 'pushbutton', ...
    'String', 'View','units', 'normalized', 'Position', [0.5 0.05 0.19 0.24], 'CallBack', {@viewRes, 'propt'}) ;
